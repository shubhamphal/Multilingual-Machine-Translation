...
PRETRAINED_TUR_DIR=checkpoints/ted_tur_flores/eng_tur
MODEL_DIR=checkpoints/ted_aze_flores/eng_aze_from_tur/
COMET_DIR=comet
mkdir -p $MODEL_DIR
...
fairseq-train \
	...
	--finetune-from-model $PRETRAINED_TUR_DIR/checkpoint_best.pt \
