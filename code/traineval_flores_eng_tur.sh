...
RAW_DATA=data/ted_raw/tur_eng/
BINARIZED_DATA=data/ted_binarized/tur_flores/eng_tur/
PRETRAINED_DIR=checkpoints/flores101_mm100_175M
MODEL_DIR=checkpoints/ted_tur_flores/eng_tur/
COMET_DIR=comet
mkdir -p $MODEL_DIR
...
python score.py "$MODEL_DIR"/test_b5.pred "$RAW_DATA"/ted-test.orig.tur \
...
python score.py "$MODEL_DIR"/valid_b5.pred "$RAW_DATA"/ted-dev.orig.tur \
