...
RAW_DATA=data/ted_raw/_eng/
BINARIZED_DATA=data/ted_binarized/tur_flores/tur_eng/
PRETRAINED_DIR=checkpoints/flores101_mm100_175M
MODEL_DIR=checkpoints/ted_tur_flores/tur_eng/
COMET_DIR=comet
mkdir -p $MODEL_DIR
...
python score.py "$MODEL_DIR"/test_b5.pred "$RAW_DATA"/ted-test.orig.eng \
    --src "$RAW_DATA"/ted-test.orig.tur \
	--comet-dir $COMET_DIR \
